...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.backgroundColor = MakeColorRGBA(0x000000, 0.7);
...
- (UILabel *)tipLab
{
    if (!_tipLab)
    {
       ...
       // _tipLab.contentEdgeInsets = UIEdgeInsetsMake(8, 20, 8, 20);
...
//    }
    ...
    [HUD.bezelView.superview layoutIfNeeded];
    HUD.bezelView.layer.cornerRadius = HUD.bezelView.height/2.0;
    HUD.tag = HUD_TAG;
