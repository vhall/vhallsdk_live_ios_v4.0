...
- (void)setupLayoutWithDict:(NSDictionary *)dict andWidth:(CGFloat)width{
    ...
    if ([dict[@"type"] intValue] == SZQuestionOpenQuestion) {
        ...
        UIButton *btn = ({
            ...
            [btn setImage:BundleUIImage(self.configure.unCheckedImage) forState:UIControlStateNormal];
            [btn setImage:BundleUIImage(self.configure.checkedImage) forState:UIControlStateSelected];
