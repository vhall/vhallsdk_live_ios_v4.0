...
- (NSString *)checkedImage {
    ...
    return _checkedImage ? _checkedImage : @"UIModel.bundle/单选";
}

- (NSString *)unCheckedImage {
    
    return _unCheckedImage ? _unCheckedImage : @"UIModel.bundle/单选空";
}

- (NSString *)multipleUncheckedImage {
    
    return _multipleUncheckedImage ? _multipleUncheckedImage : @"UIModel.bundle/多选空";
}

- (NSString *)multipleCheckedImage {
    
    return _multipleCheckedImage ? _multipleCheckedImage : @"UIModel.bundle/多选";
}
